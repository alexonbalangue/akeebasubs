# Akeeba Subscriptions 3.x (Obsolete)

This branch contains Akeeba Subscriptions 3.x which is now obsolete. There are no plans to support this version on the future and is provided only for your convenience.

If you are interested in the current version of Akeeba Subscriptions please track the development branch. The latest marked-as-stable version of Akeeba Subscriptions can be found in the master branch.
