 ...
 */
class  Sh404sefExtpluginCom_akeebasubs extends Sh404sefClassBaseextplugin {
  ...
  protected function _findSefPluginPath( $nonSefVars = array()) {
    ...
    $this->_sefPluginPath =  JPATH_ROOT . '/plugins/sh404sefextplugins/com_akeebasubs/akeebasubs/com_akeebasubs.php';
