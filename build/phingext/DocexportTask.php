 ...
 * @version $Id: DocexportTask.php 426 2011-02-03 12:53:18Z nikosdion $
...
class DocexportTask extends matchingTask
{
	...
	public function main()
	{
		...
		$customparams = empty($this->customparams) ? "" : trim($this->customparams);
		$customparams = str_replace("''",'"', $customparams);
