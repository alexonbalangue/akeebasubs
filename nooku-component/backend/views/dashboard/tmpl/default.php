...
<div id="cpanel"  style="width:51%;float:left;">
	<!--
	<h2><?//=@text('COM_AKEEBASUBS_DASHBOARD_WELCOME')?></h2>
	<?//=@template('default_welcome');?>
	-->

	<h2><?=@text('COM_AKEEBASUBS_DASHBOARD_SALES')?></h2>
	<div id="aksaleschart">
	...
	<h2><?=@text('COM_AKEEBASUBS_DASHBOARD_OPERATIONS')?></h2>
	<?=@template('default_quickicons'); ?>
</div>

<div style="width:47%;float:right;">
	<h2><?=@text('COM_AKEEBASUBS_DASHBOARD_STATS')?></h2>
