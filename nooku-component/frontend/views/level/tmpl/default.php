...
<?endif?>
	...
	<?=@helper('select.booleanlist', array('name' => 'isbusiness', 'selected' => ( !empty($userparams->isbusiness) ? $userparams->isbusiness : (@array_key_exists('isbusiness',$cache) ? $cache['isbusiness'] : 0) ) , 'deselect' => true ))?>
