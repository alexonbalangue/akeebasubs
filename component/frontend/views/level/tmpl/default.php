...
<?if(KFactory::get('lib.joomla.user')->guest):?>
	...
	<span id="username_valid" class="valid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_FIELD_USERNAME_VALID')?><span class="akstriangle akstriangle-green"></span></span>
	<span id="username_invalid" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_FIELD_USERNAME_INVALID')?><span class="akstriangle akstriangle-red"></span></span>
...
<?endif?>
	...
	<span id="name_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
	<br/>
	...
	<span id="email_invalid" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_EMAIL')?><span class="akstriangle akstriangle-red"></span></span>
	<br/>
	...
	<span id="address1_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
	<br/>
	...
	<span id="country_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
	<br/>
	<div id="stateField">
		...
		<span id="state_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
		<br/>
	</div>
	...
	<span id="city_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
	<br/>
	...
	<span id="zip_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
	<br/>
	...
	<div id="businessfields">
		...
		<span id="businessname_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
		<br/>
		...
		<span id="occupation_empty" class="invalid" style="display:none"><?=@text('COM_AKEEBASUBS_LEVEL_ERR_REQUIRED')?><span class="akstriangle akstriangle-red"></span></span>
		<br/>
		<div id="vatfields">
