...
<form action="index.php" method="post" name="adminForm" id="adminForm" class="form form-horizontal">
	...
	<input type="hidden" name="view" value="APICoupons"/>
	...
	<div class="row-fluid">
		<div class="span6">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" size="30" id="title_field" name="title"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" size="25" id="key_field" name="key"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" size="20" id="password_field" name="password"
					       value="<?php echo $this->escape($this->item->password) ?>"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo \Akeeba\Subscriptions\Admin\Helper\Select::coupontypes('type', $this->item->type) ?>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" size="20" id="value_field" name="value"
					       value="<?php echo $this->escape($this->item->value) ?>"/>
				</div>
			</div>
			<div class="control-group">
		...
		<div class="span6">
			...
			<div class="control-group">
				<label for="subscriptions_field"
				       class="control-label"><?php echo JText::_('COM_AKEEBASUBS_COUPON_FIELD_SUBSCRIPTIONS'); ?></label>

				<div class="controls">
					<?php echo \Akeeba\Subscriptions\Admin\Helper\Select::levels('subscriptions[]', empty($this->item->subscriptions) ? '-1' : explode(',', $this->item->subscriptions), array(
						'multiple' => 'multiple',
						'size'     => 3
					)) ?>
				</div>
			...
			<div class="control-group">
				<label for="usage_limits"
				       class="control-label"><?php echo JText::_('COM_AKEEBASUBS_APICOUPONS_FIELD_USAGE_LIMITS'); ?></label>
				...
				<div class="controls">
					...
					<input type="text" style="width: 50px; display:none" id="creation_limit_field" name="creation_limit"
					       value="<?php echo $this->escape($this->item->creation_limit) ?>"/>
					<input type="text" style="width: 50px; display:none" id="subscription_limit_field"
					       name="subscription_limit"
					       value="<?php echo $this->escape($this->item->subscription_limit) ?>"/>
					<input type="text" style="width: 50px; display:none" id="value_limit_field" name="value_limit"
					       value="<?php echo $this->escape($this->item->value_limit) ?>"/>
