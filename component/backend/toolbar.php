...
class AkeebasubsToolbar extends FOFToolbar
{
	...
	public function onUsersBrowse()
	{
		...
		if ($this->perms->create)
		{
			...
			$bar = JToolBar::getInstance('toolbar');
			$bar->appendButton('Link', $icon, JText::_('COM_AKEEBASUBS_IMPORT'), 'index.php?option=com_akeebasubs&view=import');
			JToolBarHelper::divider();
		}
	...
	public function onImportsAdd()
	{
		...
		JToolbarHelper::divider();
		JToolbarHelper::back('JTOOLBAR_BACK', 'index.php?option=com_akeebasubs&view=users');
	}
