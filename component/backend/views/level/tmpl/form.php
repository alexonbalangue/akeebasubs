...
<div class="tabbable">
	<ul class="nav nav-tabs">
		<li class="active">
			<a href="#maintab1" data-toggle="tab">
				<?php echo JText::_('COM_AKEEBASUBS_LEVEL_TAB_DETAILS') ?>
			</a>
		</li>
		<li>
			<a href="#maintab2" data-toggle="tab">
				<?php echo JText::_('COM_AKEEBASUBS_LEVEL_TAB_PRICEDURATION') ?>
			</a>
		</li>
		<li>
			<a href="#maintab3" data-toggle="tab">
				<?php echo JText::_('COM_AKEEBASUBS_LEVEL_TAB_ACTIONS') ?>
			</a>
		</li>
		<li>
			<a href="#maintab4" data-toggle="tab">
				<?php echo JText::_('COM_AKEEBASUBS_LEVEL_TAB_MESSAGE') ?>
			</a>
		</li>
		<li>
			<a href="#maintab5" data-toggle="tab">
				<?php echo JText::_('COM_AKEEBASUBS_LEVEL_TAB_RENEWALSNOTIFICATIONS') ?>
			</a>
		</li>
	</ul>
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="maintab1">
			...
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $editor->display( 'description',  $this->item->description, '50%', '300', '50', '10', false ) ; ?>
				</div>
			</div>
		</div>
		...
		<!-- Message -->
		<div class="tab-pane" id="maintab4">
			<div class="span6">
		...
		<div class="tab-pane" id="maintab5">
			<div class="control-group">
