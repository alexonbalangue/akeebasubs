 ...
 */
class AkeebaSubscriptionsUpdateApp extends JApplicationCli
{
	/**
	...
	public function execute()
	{
        ...
        $jlang->load('com_akeebasubs', JPATH_ADMINISTRATOR);
        $jlang->load('com_akeebasubs.override', JPATH_ADMINISTRATOR);
		...
		$this->out("Akeeba Subscriptions Updater CLI " . AKEEBASUBS_VERSION . " (" . AKEEBASUBS_DATE . ")");
...
$app = JApplicationCli::getInstance('AkeebaSubscriptionsUpdateApp');
