...
class JFormFieldInvoicetemplate extends JFormField
{
	function getInput()
	{
		$db = JFactory::getDbo();
		...
		return JHTML::_('select.genericlist', $options, 'jform[params][invoice_template]', '', 'value', 'text', $this->value);
	}
}