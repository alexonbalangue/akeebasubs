	...
	<div class="span6">
		<div class="control-group">
			<label for="params_atscredits_credits" class="control-label">
				<?php echo JText::_('PLG_AKEEBASUBS_ATSCREDITSLEGACY_CREDITS_TITLE'); ?>
			</label>
			<div class="controls">
				...
				<span class="help-block">
					<?php echo JText::_('PLG_AKEEBASUBS_ATSCREDITSLEGACY_CREDITS_DESC') ?>
				</span>
			</div>
		</div>
	</div>
...
<div class="alert alert-warning">
	<p><?php echo JText::_('PLG_AKEEBASUBS_ATSCREDITSLEGACY_USAGENOTE'); ?></p>
</div>