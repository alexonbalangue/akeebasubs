...
class plgAkpaymentMobilpaycc extends plgAkpaymentAbstract
{
	...
	public function onAKPaymentNew($paymentmethod, $user, $level, $subscription)
	{
		...
		try{
			...
			$objPmReqCard->confirmUrl 			= $rootURL.JRoute::_('index.php?option=com_akeebasubs&view=message&slug='.$slug.'&layout=order&subid='.$subscription->akeebasubs_subscription_id, false);
			$objPmReqCard->returnUrl 			= JURI::base().'index.php?option=com_akeebasubs&view=callback&paymentmethod=mobilpaycc';
